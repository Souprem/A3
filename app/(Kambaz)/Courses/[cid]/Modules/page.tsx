      ...
      <ListGroup className="rounded-0" id="wd-modules">
        ...
        <ListGroupItem className="wd-module p-0 mb-5 fs-5 border-gray">
          ...
          <ListGroup className="wd-lessons rounded-0">
            ...
            <ListGroupItem className="wd-lesson p-3 ps-1">
              <BsGripVertical className="me-2 fs-3" /> Learn about CSS{" "}
              <LessonControlButtons />
            </ListGroupItem>
            <ListGroupItem className="wd-lesson p-3 ps-1">
              <BsGripVertical className="me-2 fs-3" /> Learn about Bootstrap{" "}
              <LessonControlButtons />
            </ListGroupItem>
          </ListGroup>
        </ListGroupItem>
        ...
        <ListGroupItem className="wd-module p-0 mb-5 fs-5 border-gray">
          ...
          <ListGroup className="wd-lessons rounded-0">
            ...
            <ListGroupItem className="wd-lesson p-3 ps-1">
              <BsGripVertical className="me-2 fs-3" /> Learn JavaScript basics{" "}
              <LessonControlButtons />
            </ListGroupItem>
            <ListGroupItem className="wd-lesson p-3 ps-1">
              <BsGripVertical className="me-2 fs-3" /> Learn about React
              components <LessonControlButtons />
            </ListGroupItem>
          </ListGroup>
        </ListGroupItem>
      </ListGroup>
